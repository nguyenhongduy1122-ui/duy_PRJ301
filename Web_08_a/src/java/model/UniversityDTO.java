...
public class UniversityDTO {
    ...
    public UniversityDTO(String id, String name, String shortName, String description, int foundedYear, String address, String city, String region, String typeString, int totalStudent, int totalFaculties, boolean isDraft) {
        this.id = id;
        this.name = name;
